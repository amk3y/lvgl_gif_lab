...
lv_disp_t* init_display_st7735(esp_lcd_panel_handle_t* ret_lcd_handle){
    ...
    ESP_ERROR_CHECK(esp_lcd_new_panel_st7735(io_handle, &panel_config, ret_lcd_handle));
    ...
    // depend on hardware
    esp_lcd_panel_invert_color(*ret_lcd_handle, false);
    esp_lcd_panel_set_gap(*ret_lcd_handle, 2, 3);
